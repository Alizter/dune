...
Printing out PATH without setting it when the package has a dependency:
  ...
  PATH=$PWD/_build/_default+lockfile/pkg/hello2/.opam/hello2/target/bin:$PWD/_build/_default+lockfile/pkg/hello1/.opam/hello1/target/bin:DUNE_PATH:/bin
...
Attempting to add a path to PATH replaces the entire PATH:
  ...
  PATH=/tmp/bin:$PWD/_build/_default+lockfile/pkg/hello2/.opam/hello2/target/bin:$PWD/_build/_default+lockfile/pkg/hello1/.opam/hello1/target/bin:DUNE_PATH:/bin
...
Try adding multiple paths to PATH:
  ...
  $ dune clean
  $ PATH=$DUNE_PATH:/bin build_pkg test 2>&1 | $DUNE_CMD subst "$DUNE_PATH" 'DUNE_PATH' | censor
  PATH=/bar/bin:/foo/bin:/tmp/bin:$PWD/_build/_default+lockfile/pkg/hello2/.opam/hello2/target/bin:$PWD/_build/_default+lockfile/pkg/hello1/.opam/hello1/target/bin:DUNE_PATH:/bin
