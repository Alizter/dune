...
lockdir package:
  ...
  "_build/_default+lockfile/pkg/tool_provider/.opam/tool_provider/target/bin/ocamllex"
  "_build/default/foo.mll"
  $ dune rules --format=json bar.ml | jq_dune '.[] | ruleDepFilePaths' | censor
  "_build/_default+lockfile/pkg/tool_provider/.opam/tool_provider/target/bin/menhir"
...
The tool_provider bin directory is added to $PATH:
  ...
  $PWD/_build/_default+lockfile/pkg/tool_provider/.opam/tool_provider/target/bin
