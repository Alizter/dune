...
Binary directory comparisons are valid since Dune 3.23. Replay preserves
the directory-diffs flag of the prepared cmp action.
  ...
  > test ! -s replay.stderr && echo "binary-directory-replay-stderr: empty"
  > '
