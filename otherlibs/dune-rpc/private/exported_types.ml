...
module Ansi_color = struct
  module RGB8 = struct
    ...
    let sexp = Conv.char
    let to_ansi_color_rgb8 t = Stdune.Ansi_color.RGB8.of_char t
    let of_ansi_color_rgb8 t = Stdune.Ansi_color.RGB8.to_char t
  end
  ...
  module RGB24 = struct
    ...
    let sexp = Conv.int
    let to_ansi_color_rgb24 t = Stdune.Ansi_color.RGB24.of_int t
    let of_ansi_color_rgb24 t = Stdune.Ansi_color.RGB24.to_int t
  end
  ...
  module Style = struct
    ...
    let to_ansi_color_style : t -> Stdune.Ansi_color.Style.t = function
      ...
      | Fg_cyan -> `Fg_cyan
      | Fg_white -> `Fg_white
      | Fg_bright_black -> `Fg_bright_black
      | Fg_bright_red -> `Fg_bright_red
      | Fg_bright_green -> `Fg_bright_green
      | Fg_bright_yellow -> `Fg_bright_yellow
      | Fg_bright_blue -> `Fg_bright_blue
      | Fg_bright_magenta -> `Fg_bright_magenta
      | Fg_bright_cyan -> `Fg_bright_cyan
      | Fg_bright_white -> `Fg_bright_white
      | Fg_8_bit_color c -> `Fg_8_bit_color (RGB8.to_ansi_color_rgb8 c)
      | Fg_24_bit_color c -> `Fg_24_bit_color (RGB24.to_ansi_color_rgb24 c)
      ...
      | Bg_8_bit_color c -> `Bg_8_bit_color (RGB8.to_ansi_color_rgb8 c)
      | Bg_24_bit_color c -> `Bg_24_bit_color (RGB24.to_ansi_color_rgb24 c)
      | Bold -> `Bold
      | Dim -> `Dim
      | Italic -> `Italic
      | Underline -> `Underline
    ...
    let of_ansi_color_style : Stdune.Ansi_color.Style.t -> t = function
      | `Fg_default -> Fg_default
      | `Fg_black -> Fg_black
      | `Fg_red -> Fg_red
      | `Fg_green -> Fg_green
      ...
      | `Fg_bright_cyan -> Fg_bright_cyan
      | `Fg_bright_white -> Fg_bright_white
      | `Fg_8_bit_color c -> Fg_8_bit_color (RGB8.of_ansi_color_rgb8 c)
      | `Fg_24_bit_color c -> Fg_24_bit_color (RGB24.of_ansi_color_rgb24 c)
      | `Bg_default -> Bg_default
      | `Bg_black -> Bg_black
      | `Bg_red -> Bg_red
      | `Bg_green -> Bg_green
      ...
      | `Bg_bright_cyan -> Bg_bright_cyan
      | `Bg_bright_white -> Bg_bright_white
      | `Bg_8_bit_color c -> Bg_8_bit_color (RGB8.of_ansi_color_rgb8 c)
      | `Bg_24_bit_color c -> Bg_24_bit_color (RGB24.of_ansi_color_rgb24 c)
      | `Bold -> Bold
      | `Dim -> Dim
      | `Italic -> Italic
      | `Underline -> Underline
...
module User_message = struct
  module Style = struct
    ...
    let to_user_message_style : t -> Stdune.User_message.Style.t = function
      | Loc -> Loc
      | Error -> Error
      | Warning -> Warning
      | Kwd -> Kwd
      ...
      | Debug -> Debug
      | Success -> Success
      | Ansi_styles l -> Ansi_styles (List.map ~f:Ansi_color.Style.to_ansi_color_style l)
    ;;

    let of_user_message_style : Stdune.User_message.Style.t -> t = function
      | Loc -> Loc
      | Error -> Error
      | Warning -> Warning
      | Kwd -> Kwd
      ...
      | Debug -> Debug
      | Success -> Success
      | Ansi_styles l -> Ansi_styles (List.map ~f:Ansi_color.Style.of_ansi_color_style l)
    ;;
  end
end
...
module Diagnostic = struct
  ...
  let to_user_message t =
    ...
    Stdune.User_message.make
      ?loc
      [ Pp.map_tags ~f:User_message.Style.to_user_message_style t.message ]
  ;;
...
module Job = struct
  ...
  let sexp =
    ...
    let description = field "description" (required (sexp_pp unit)) in
