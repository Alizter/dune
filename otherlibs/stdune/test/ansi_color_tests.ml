                            ...
                            Verbatim
                              " string with ",Tag
                                                ...
                                                Verbatim
                                                  "red",Verbatim " and ",
                      Tag
                        [ Fg_24_bit_color 0,0,255 ],Verbatim "green",Verbatim
                                                                       " together with strings of a ",
                  Tag
                    [ Bg_24_bit_color 255,0,0 ],Verbatim "blue blackground",
                Verbatim
                  " and ",Tag
                            [ Bg_24_bit_color 0,255,0 ],Verbatim "red background",
            Verbatim
              " and ",Tag [ Bg_24_bit_color 0,0,255 ],Verbatim "green background"
|}]
