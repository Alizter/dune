...
let opam = Alias.Name.of_string "opam"
...
let revdep = standard "revdep"
let revdep_check = standard "revdep-check"
let revdep_runtest = standard "revdep-runtest"
let revdep_install = standard "revdep-install"
let unused_libs = standard "unused-libs"
let unused = standard "unused"
let unused_all = standard "unused-all"
