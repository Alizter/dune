...
val source_dir : t -> Path.Build.t -> Source_path.t
...
module DB : sig
  ...
  val public_libs_by_dir : Path.Build.t -> Lib.DB.t Memo.t
  ...
  val lib_entries_of_loaded_project
    :  Context_name.t
    -> Loaded_project.t
    -> Package.Name.t
    -> (Lib_entry.Set.t * t) Memo.t
