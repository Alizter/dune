...
module Parser_generators : sig
  ...
  (** Target trie keys are full paths within the source trie. *)
  type dep_info =
    { deps : Path.Set.t
...
(** For each module produced by a parser generator, which generator produced
    it. Keyed by logical module path. Modules absent from this map were not
    generated by [ocamllex], [ocamlyacc], or [menhir]. *)
val parser_gen_origins : t -> Parser_gen_origin.t Module_name.Path.Map.t
